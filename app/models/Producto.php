...
class Producto
{
    ...
    public function crearProductoConId()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO productos (productoId, nombre, perfil, precio, activo)
         VALUES (:productoId, :nombre, :perfil, :precio, :activo)");
    ...
    public static function modificarProductoCompleto($producto)
    {
        try{
            if(isset($producto)){     
                $objAccesoDato = AccesoDatos::obtenerInstancia();
                $consulta = $objAccesoDato->prepararConsulta("UPDATE productos
                SET precio = :precio, nombre = :nombre, perfil = :perfil, activo = :activo
                WHERE productoId = :productoId");
              
                $consulta->bindValue(':productoId', $producto->productoId, PDO::PARAM_INT);
                $consulta->bindValue(':nombre', $producto->nombre, PDO::PARAM_STR);
                $consulta->bindValue(':precio', $producto->precio, PDO::PARAM_STR);
                $consulta->bindValue(':perfil', $producto->perfil, PDO::PARAM_STR);
